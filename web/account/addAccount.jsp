...
<html>
    ...
    <body>                <% if(Authentificate.getSession() == null || Authentificate.getSession().isEmpty())  response.sendRedirect("Login.action");%>             
        ...
        <div class="wrapper row0" style="margin-top: 20px; margin-right: 50px">
            ...
            <div class="wrapper row1">
                ...
                <div id="logo" class="fl_left" style="float: left;margin-right: 20px">
                    <h1><s:text name="main.menu.addaccount"/></h1>
                </div>
                <nav id="mainav" class="fl_right">
                    ...
                    <li class="active"><s:a href="%{addAccountUrl}">
    ...
    <center><div style="width: 800px">
        ...
        <s:url id="createClient" action="createClientJSP"></s:url>
        <p>The client doesn't exist? <s:a href="%{createClient}">Create a new one</s:a>.</p>
    </body>
</html>
