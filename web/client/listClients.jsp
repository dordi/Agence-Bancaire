        ...
        <div class="wrapper row0" style="margin-top: 20px; margin-right: 80px">
            ...
            <div class="wrapper row1">
                ...
                <div id="logo" class="fl_left" style="float: left;margin-right: 50px">
                    <h1><s:text name="main.menu.listclients"/></h1>
                </div>
                <nav id="mainav" class="fl_right">
                    ...
                    <li class="active"><s:a href="%{listClientUrl}">
    ...
    <center><div style="width: 800px">
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <s:iterator value="clientList">
                    <tr>
                        <td ><s:property value="firstName" default="" /> <s:property value="lastName" default="" /></td>
                        <td><s:property value="cin" default="" /></td>
                        <td><s:property value="address" default="" /></td>
                        <td ><s:property value="phoneNumber" default="" /></td>
                        <td ><s:property value="job" default="" /></td>
                        <s:url id="edit" action="editClientInit">
                            <s:param name="cin" value="%{cin}" />
                        </s:url>
                        <s:url id="delete" action="deleteClient">
                            <s:param name="cin" value="%{cin}" />
                        </s:url>
